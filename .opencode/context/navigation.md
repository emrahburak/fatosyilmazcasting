...
|------|-------------|----------|
| project-intelligence/technical-domain.md | Tech stack, patterns, naming, security, i18n (v1.4) | critical |
...
| Task | Path |
|------|------|
| **Project patterns** | `project-intelligence/technical-domain.md` |
